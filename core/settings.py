...
class Settings(Stateful):
    ...
    @classmethod
    @option
    def disconnect_bluetooth(cls, _request):
    ...
    @classmethod
    @option
    def available_ssids(cls, _request):
    ...
    @classmethod
    @option
    def connect_to_wifi(cls, request):
    ...
    @classmethod
    @option
    def set_homewifi_ssid(cls, request):
    ...
    @classmethod
    @option
    def list_subdirectories(cls, request):
    ...
    @classmethod
    @option
    def disable_tunneling(cls, _request):
    ...
    @classmethod
    @option
    def enable_tunneling(cls, _request):
    ...
    @classmethod
    @option
    def reboot_server(cls, _request):
        """Restarts the server."""
        subprocess.call(["sudo", "/usr/local/sbin/raveberry/reboot_server"])

    @classmethod
    @option
    def reboot_system(cls, _request):
        """Reboots the system."""
